...
\declaredocument{Multiagent Simulation}{MABS Lab Work \#1}{UTBM-INFO-IA54-MABS-LW1}
...
\Set[french]{institution}{D\'epartement Informatique}
\Set[english]{institution}{Computer Science Department}
...
In the code skeleton, this skill is named \texttt{DefaultMazeManagerSkill}, and all the functions marked with \code {TODO} must be coded.
